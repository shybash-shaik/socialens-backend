...
/* eslint-disable */
'use strict';let yu=Object.create;let jt=Object.defineProperty;let bu=Object.getOwnPropertyDescriptor;let Eu=Object.getOwnPropertyNames;let wu=Object.getPrototypeOf,xu=Object.prototype.hasOwnProperty;let Do=(e,r) => () => (e&&(r=e(e=0)),r);let ue=(e,r) => () => (r||e((r={exports:{}}).exports,r),r.exports),tr=(e,r) => {for(let t in r)jt(e,t,{get:r[t],enumerable:!0});},Oo=(e,r,t,n) => {if(r&&typeof r=='object'||typeof r=='function')for(const i of Eu(r))!xu.call(e,i)&&i!==t&&jt(e,i,{get:() => r[i],enumerable:!(n=bu(r,i))||n.enumerable});return e;};let O=(e,r,t) => (t=e!=null?yu(wu(e)):{},Oo(r||!e||!e.__esModule?jt(t,'default',{value:e,enumerable:!0}):t,e)),vu=e => Oo(jt({},'__esModule',{value:!0}),e);let hi=ue((_g,is) => {'use strict';is.exports=(e,r=process.argv) => {const t=e.startsWith("-")?"":e.length===1?"-":"--",n=r.indexOf(t+e),i=r.indexOf("--");return n!==-1&&(i===-1||n<i);};});let as=ue((Ng,ss) => {'use strict';let Fc=require('node:os'),os=require('node:tty'),de=hi(),{env:G}=process,Qe;de('no-color')||de('no-colors')||de('color=false')||de('color=never')?Qe=0:(de('color')||de('colors')||de('color=true')||de('color=always'))&&(Qe=1);'FORCE_COLOR'in G&&(G.FORCE_COLOR==='true'?Qe=1:G.FORCE_COLOR==='false'?Qe=0:Qe=G.FORCE_COLOR.length===0?1:Math.min(parseInt(G.FORCE_COLOR,10),3));function yi(e){return e===0?!1:{level:e,hasBasic:!0,has256:e>=2,has16m:e>=3};}function bi(e,r){if(Qe===0)return 0;if(de('color=16m')||de('color=full')||de('color=truecolor'))return 3;if(de('color=256'))return 2;if(e&&!r&&Qe===void 0)return 0;const t=Qe||0;if(G.TERM==='dumb')return t;if(process.platform==='win32'){const n=Fc.release().split(".");return Number(n[0])>=10&&Number(n[2])>=10586?Number(n[2])>=14931?3:2:1;}if('CI'in G)return['TRAVIS','CIRCLECI','APPVEYOR','GITLAB_CI','GITHUB_ACTIONS','BUILDKITE'].some(n => n in G)||G.CI_NAME==='codeship'?1:t;if('TEAMCITY_VERSION'in G)return/^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(G.TEAMCITY_VERSION)?1:0;if(G.COLORTERM==='truecolor')return 3;if('TERM_PROGRAM'in G){const n=parseInt((G.TERM_PROGRAM_VERSION||"").split(".")[0],10);switch(G.TERM_PROGRAM){case'iTerm.app':return n>=3?3:2;case'Apple_Terminal':return 2;}}return/-256(color)?$/i.test(G.TERM)?2:/^screen|^xterm|^vt100|^vt220|^rxvt|color|ansi|cygwin|linux/i.test(G.TERM)||'COLORTERM'in G?1:t;}function Mc(e){const r=bi(e,e&&e.isTTY);return yi(r);}ss.exports={supportsColor:Mc,stdout:yi(bi(!0,os.isatty(1))),stderr:yi(bi(!0,os.isatty(2)))};});let cs=ue((Lg,us) => {'use strict';let $c=as(),br=hi();function ls(e){if(/^\d{3,4}$/.test(e)){const t=/(\d{1,2})(\d{2})/.exec(e)||[];return{major:0,minor:parseInt(t[1],10),patch:parseInt(t[2],10)};}const r=(e||"").split(".").map(t=>parseInt(t,10));return{major:r[0],minor:r[1],patch:r[2]};}function Ei(e){const{CI:r,FORCE_HYPERLINK:t,NETLIFY:n,TEAMCITY_VERSION:i,TERM_PROGRAM:o,TERM_PROGRAM_VERSION:s,VTE_VERSION:a,TERM:l}=process.env;if(t)return!(t.length>0&&parseInt(t,10)===0);if(br('no-hyperlink')||br('no-hyperlinks')||br('hyperlink=false')||br('hyperlink=never'))return!1;if(br('hyperlink=true')||br('hyperlink=always')||n)return!0;if(!$c.supportsColor(e)||e&&!e.isTTY)return!1;if('WT_SESSION'in process.env)return!0;if(process.platform==='win32'||r||i)return!1;if(o){const u=ls(s||"");switch(o){case'iTerm.app':return u.major===3?u.minor>=1:u.major>3;case'WezTerm':return u.major>=20200620;case'vscode':return u.major>1||u.major===1&&u.minor>=72;case'ghostty':return!0;}}if(a){if(a==='0.50.0')return!1;const u=ls(a);return u.major>0||u.minor>=50;}switch(l){case'alacritty':return!0;}return!1;}us.exports={supportsHyperlink:Ei,stdout:Ei(process.stdout),stderr:Ei(process.stderr)};});let ps=ue((Kg,qc) => {qc.exports={name:'@prisma/internals',version:'6.16.3',description:"This package is intended for Prisma's internal use",main:'dist/index.js',types:'dist/index.d.ts',repository:{type:'git',url:'https://github.com/prisma/prisma.git',directory:'packages/internals'},homepage:'https://www.prisma.io',author:'Tim Suchanek <suchanek@prisma.io>',bugs:'https://github.com/prisma/prisma/issues',license:'Apache-2.0',scripts:{dev:'DEV=true tsx helpers/build.ts',build:'tsx helpers/build.ts',test:'dotenv -e ../../.db.env -- jest --silent',prepublishOnly:'pnpm run build'},files:['README.md','dist','!**/libquery_engine*','!dist/get-generators/engines/*','scripts'],devDependencies:{'@babel/helper-validator-identifier':'7.25.9','@opentelemetry/api':'1.9.0','@swc/core':'1.11.5','@swc/jest':'0.2.37','@types/babel__helper-validator-identifier':'7.15.2','@types/jest':'29.5.14','@types/node':'18.19.76','@types/resolve':'1.20.6',archiver:'6.0.2','checkpoint-client':'1.1.33','cli-truncate':'4.0.0',dotenv:'16.5.0',empathic:'2.0.0','escape-string-regexp':'5.0.0',execa:'5.1.1','fast-glob':'3.3.3','find-up':'7.0.0','fp-ts':'2.16.9','fs-extra':'11.3.0','fs-jetpack':'5.1.0','global-directory':'4.0.0',globby:'11.1.0','identifier-regex':'1.0.0','indent-string':'4.0.0','is-windows':'1.0.2','is-wsl':'3.1.0',jest:'29.7.0','jest-junit':'16.0.0',kleur:'4.1.5','mock-stdin':'1.0.0','new-github-issue-url':'0.2.1','node-fetch':'3.3.2','npm-packlist':'5.1.3',open:'7.4.2','p-map':'4.0.0',resolve:'1.22.10','string-width':'7.2.0','strip-indent':'4.0.0','temp-dir':'2.0.0',tempy:'1.0.1','terminal-link':'4.0.0',tmp:'0.2.3','ts-pattern':'5.6.2','ts-toolbelt':'9.6.0',typescript:'5.4.5',yarn:'1.22.22'},dependencies:{'@prisma/config':'workspace:*','@prisma/debug':'workspace:*','@prisma/dmmf':'workspace:*','@prisma/driver-adapter-utils':'workspace:*','@prisma/engines':'workspace:*','@prisma/fetch-engine':'workspace:*','@prisma/generator':'workspace:*','@prisma/generator-helper':'workspace:*','@prisma/get-platform':'workspace:*','@prisma/prisma-schema-wasm':'6.16.1-1.bb420e667c1820a8c05a38023385f6cc7ef8e83a','@prisma/schema-engine-wasm':'6.16.1-1.bb420e667c1820a8c05a38023385f6cc7ef8e83a','@prisma/schema-files-loader':'workspace:*',arg:'5.0.2',prompts:'2.4.2'},peerDependencies:{typescript:'>=5.1.0'},peerDependenciesMeta:{typescript:{optional:!0}},sideEffects:!1};});let Ti=ue((gh,Qc) => {Qc.exports={name:'@prisma/engines-version',version:'6.16.1-1.bb420e667c1820a8c05a38023385f6cc7ef8e83a',main:'index.js',types:'index.d.ts',license:'Apache-2.0',author:'Tim Suchanek <suchanek@prisma.io>',prisma:{enginesVersion:'bb420e667c1820a8c05a38023385f6cc7ef8e83a'},repository:{type:'git',url:'https://github.com/prisma/engines-wrapper.git',directory:'packages/engines-version'},devDependencies:{'@types/node':'18.19.76',typescript:'4.9.5'},files:['index.js','index.d.ts'],scripts:{build:'tsc -d'}};});let on=ue(nn => {'use strict';Object.defineProperty(nn,'__esModule',{value:!0});nn.enginesVersion=void 0;nn.enginesVersion=Ti().prisma.enginesVersion;});let hs=ue((Ih,gs) => {'use strict';gs.exports=e => {const r=e.match(/^[ \t]*(?=\S)/gm);return r?r.reduce((t,n) => Math.min(t,n.length),1/0):0;};});let Di=ue((kh,Es) => {'use strict';Es.exports=(e,r=1,t) => {if(t={indent:' ',includeEmptyLines:!1,...t},typeof e!='string')throw new TypeError(`Expected \`input\` to be a \`string\`, got \`${typeof e}\``);if(typeof r!='number')throw new TypeError(`Expected \`count\` to be a \`number\`, got \`${typeof r}\``);if(typeof t.indent!='string')throw new TypeError(`Expected \`options.indent\` to be a \`string\`, got \`${typeof t.indent}\``);if(r===0)return e;const n=t.includeEmptyLines?/^/gm:/^(?!\s*$)/gm;return e.replace(n,t.indent.repeat(r));};});let vs=ue((jh,tp) => {tp.exports={name:'dotenv',version:'16.5.0',description:'Loads environment variables from .env file',main:'lib/main.js',types:'lib/main.d.ts',exports:{'.':{types:'./lib/main.d.ts',require:'./lib/main.js',default:'./lib/main.js'},'./config':'./config.js','./config.js':'./config.js','./lib/env-options':'./lib/env-options.js','./lib/env-options.js':'./lib/env-options.js','./lib/cli-options':'./lib/cli-options.js','./lib/cli-options.js':'./lib/cli-options.js','./package.json':'./package.json'},scripts:{'dts-check':'tsc --project tests/types/tsconfig.json',lint:'standard',pretest:'npm run lint && npm run dts-check',test:'tap run --allow-empty-coverage --disable-coverage --timeout=60000','test:coverage':'tap run --show-full-coverage --timeout=60000 --coverage-report=lcov',prerelease:'npm test',release:'standard-version'},repository:{type:'git',url:'git://github.com/motdotla/dotenv.git'},homepage:'https://github.com/motdotla/dotenv#readme',funding:'https://dotenvx.com',keywords:['dotenv','env','.env','environment','variables','config','settings'],readmeFilename:'README.md',license:'BSD-2-Clause',devDependencies:{'@types/node':'^18.11.3',decache:'^4.6.2',sinon:'^14.0.1',standard:'^17.0.0','standard-version':'^9.5.0',tap:'^19.2.0',typescript:'^4.8.4'},engines:{node:'>=12'},browser:{fs:!1}};});let As=ue((Bh,_e) => {'use strict';let Fi=require('node:fs'),Mi=require('node:path'),np=require('node:os'),ip=require('node:crypto'),op=vs(),Ts=op.version,sp=/(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;function ap(e){let r={},t=e.toString();t=t.replace(/\r\n?/mg,`
`
    );
    let n;
...
`);}};let hd={red:ce,gray:Hr,dim:Ce,bold:W,underline:Y,highlightSource:e => e.highlight()},yd={red:e => e,gray:e => e,dim:e => e,bold:e => e,underline:e => e,highlightSource:e => e};function bd({message:e,originalMethod:r,isPanic:t,callArguments:n}){return{functionName:`prisma.${r}()`,message:e,isPanic:t??!1,callArguments:n};}function Ed({callsite:e,message:r,originalMethod:t,isPanic:n,callArguments:i},o){const s=bd({message:r,originalMethod:t,isPanic:n,callArguments:i});if(!e||typeof window<'u'||process.env.NODE_ENV==='production')return s;const a=e.getLocation();if(!a||!a.lineNumber||!a.columnNumber)return s;let l=Math.max(1,a.lineNumber-3),u=Pn.read(a.fileName)?.slice(l,a.lineNumber),c=u?.lineAt(a.lineNumber);if(u&&c){const p=xd(c),d=wd(c);if(!d)return s;s.functionName=`${d.code})`,s.location=a,n||(u=u.mapLineAt(a.lineNumber,h => h.slice(0,d.openingBraceIndex))),u=o.highlightSource(u);const f=String(u.lastLineNumber).length;if(s.contextLines=u.mapLines((h,g) => o.gray(String(g).padStart(f))+' '+h).mapLines(h => o.dim(h)).prependSymbolAt(a.lineNumber,o.bold(o.red('\u2192'))),i){let h=p+f+1;h+=2,s.callArguments=(0,Xs.default)(i,h).slice(h);}}return s;}function wd(e){const r=Object.keys(Rr).join("|"),n=new RegExp(String.raw`\.(${r})\(`).exec(e);if(n){const i=n.index+n[0].length,o=e.lastIndexOf(" ",n.index)+1;return{code:e.slice(o,i),openingBraceIndex:i};}return null;}function xd(e){let r=0;for(let t=0;t<e.length;t++){if(e.charAt(t)!==' ')return r;r++;}return r;}function vd({functionName:e,location:r,message:t,isPanic:n,contextLines:i,callArguments:o},s){const a=[""],l=r?" in":":";if(n?(a.push(s.red(`Oops, an unknown error occurred! This is ${s.bold('on us')}, you did nothing wrong.`)),a.push(s.red(`It occurred in the ${s.bold(`\`${e}\``)} invocation${l}`))):a.push(s.red(`Invalid ${s.bold(`\`${e}\``)} invocation${l}`)),r&&a.push(s.underline(Pd(r))),i){a.push('');const u=[i.toString()];o&&(u.push(o),u.push(s.dim(')'))),a.push(u.join('')),o&&a.push('');}else a.push(''),o&&a.push(o),a.push('');return a.push(t),a.join(`
`);}function Pd(e){const r=[e.fileName];return e.lineNumber&&r.push(String(e.lineNumber)),e.columnNumber&&r.push(String(e.columnNumber)),r.join(':');}function Tn(e){let r=e.showColors?hd:yd,t;return t=Ed(e,r),vd(t,r);}let la=O(Ki());function na(e,r,t){const n=ia(e),i=Td(n),o=Rd(i);o?Sn(o,r,t):r.addErrorMessage(() => "Unknown error");}function ia(e){return e.errors.flatMap(r => r.kind==='Union'?ia(r):[r]);}function Td(e){const r=new Map,t=[];for(const n of e){if(n.kind!=='InvalidArgumentType'){t.push(n);continue;}const i=`${n.selectionPath.join(".")}:${n.argumentPath.join(".")}`,o=r.get(i);o?r.set(i,{...n,argument:{...n.argument,typeNames:Sd(o.argument.typeNames,n.argument.typeNames)}}):r.set(i,n);}return t.push(...r.values()),t;}function Sd(e,r){return[...new Set(e.concat(r))];}function Rd(e){return ji(e,(r,t) => {const n=ra(r),i=ra(t);return n!==i?n-i:ta(r)-ta(t);});}function ra(e){let r=0;return Array.isArray(e.selectionPath)&&(r+=e.selectionPath.length),Array.isArray(e.argumentPath)&&(r+=e.argumentPath.length),r;}function ta(e){switch(e.kind){case'InvalidArgumentValue':case'ValueTooLarge':return 20;case'InvalidArgumentType':return 10;case'RequiredArgumentMissing':return-10;default:return 0;}}let le=class{constructor(r,t){this.name=r;this.value=t;}isRequired=!1;makeRequired(){return this.isRequired=!0,this;}write(r){const{colors:{green:t}}=r.context;r.addMarginSymbol(t(this.isRequired?'+':'?')),r.write(t(this.name)),this.isRequired||r.write(t('?')),r.write(t(': ')),typeof this.value=='string'?r.write(t(this.value)):r.write(this.value);}};sa();let Ar=class{constructor(r=0,t){this.context=t;this.currentIndent=r;}lines=[];currentLine='';currentIndent=0;marginSymbol;afterNextNewLineCallback;write(r){return typeof r=='string'?this.currentLine+=r:r.write(this),this;}writeJoined(r,t,n=(i,o) => o.write(i)){const i=t.length-1;for(let o=0;o<t.length;o++)n(t[o],this),o!==i&&this.write(r);return this;}writeLine(r){return this.write(r).newLine();}newLine(){this.lines.push(this.indentedCurrentLine()),this.currentLine='',this.marginSymbol=void 0;const r=this.afterNextNewLineCallback;return this.afterNextNewLineCallback=void 0,r?.(),this;}withIndent(r){return this.indent(),r(this),this.unindent(),this;}afterNextNewline(r){return this.afterNextNewLineCallback=r,this;}indent(){return this.currentIndent++,this;}unindent(){return this.currentIndent>0&&this.currentIndent--,this;}addMarginSymbol(r){return this.marginSymbol=r,this;}toString(){return this.lines.concat(this.indentedCurrentLine()).join(`
`);}getCurrentLineLength(){return this.currentLine.length;}indentedCurrentLine(){const r=this.currentLine.padStart(this.currentLine.length+2*this.currentIndent);return this.marginSymbol?this.marginSymbol+r.slice(1):r;}};oa();let Rn=class{constructor(r){this.value=r;}write(r){r.write(this.value);}markAsError(){this.value.markAsError();}};let An=e => e,Cn={bold:An,red:An,green:An,dim:An,enabled:!1},aa={bold:W,red:ce,green:qe,dim:Ce,enabled:!0},Cr={write(e){e.writeLine(',');}};let Pe=class{constructor(r){this.contents=r;}isUnderlined=!1;color=r => r;underline(){return this.isUnderlined=!0,this;}setColor(r){return this.color=r,this;}write(r){const t=r.getCurrentLineLength();r.write(this.color(this.contents)),this.isUnderlined&&r.afterNextNewline(() => {r.write(' '.repeat(t)).writeLine(this.color('~'.repeat(this.contents.length)));});}};let ze=class{hasError=!1;markAsError(){return this.hasError=!0,this;}};let Ir=class extends ze{items=[];addItem(r){return this.items.push(new Rn(r)),this;}getField(r){return this.items[r];}getPrintWidth(){return this.items.length===0?2:Math.max(...this.items.map(t => t.value.getPrintWidth()))+2;}write(r){if(this.items.length===0){this.writeEmpty(r);return;}this.writeWithItems(r);}writeEmpty(r){const t=new Pe("[]");this.hasError&&t.setColor(r.context.colors.red).underline(),r.write(t);}writeWithItems(r){const{colors:t}=r.context;r.writeLine('[').withIndent(() => r.writeJoined(Cr,this.items).newLine()).write(']'),this.hasError&&r.afterNextNewline(() => {r.writeLine(t.red('~'.repeat(this.getPrintWidth())));});}asObject(){}};let Dr=class e extends ze{fields={};suggestions=[];addField(r){this.fields[r.name]=r;}addSuggestion(r){this.suggestions.push(r);}getField(r){return this.fields[r];}getDeepField(r){const[t,...n]=r,i=this.getField(t);if(!i)return;let o=i;for(const s of n){let a;if(o.value instanceof e?a=o.value.getField(s):o.value instanceof Ir&&(a=o.value.getField(Number(s))),!a)return;o=a;}return o;}getDeepFieldValue(r){return r.length===0?this:this.getDeepField(r)?.value;}hasField(r){return!!this.getField(r);}removeAllFields(){this.fields={};}removeField(r){delete this.fields[r];}getFields(){return this.fields;}isEmpty(){return Object.keys(this.fields).length===0;}getFieldValue(r){return this.getField(r)?.value;}getDeepSubSelectionValue(r){let t=this;for(const n of r){if(!(t instanceof e))return;const i=t.getSubSelectionValue(n);if(!i)return;t=i;}return t;}getDeepSelectionParent(r){const t=this.getSelectionParent();if(!t)return;let n=t;for(const i of r){const o=n.value.getFieldValue(i);if(!o||!(o instanceof e))return;const s=o.getSelectionParent();if(!s)return;n=s;}return n;}getSelectionParent(){const r=this.getField("select")?.value.asObject();if(r)return{kind:'select',value:r};const t=this.getField("include")?.value.asObject();if(t)return{kind:'include',value:t};}getSubSelectionValue(r){return this.getSelectionParent()?.value.fields[r].value;}getPrintWidth(){const r=Object.values(this.fields);return r.length==0?2:Math.max(...r.map(n => n.getPrintWidth()))+2;}write(r){const t=Object.values(this.fields);if(t.length===0&&this.suggestions.length===0){this.writeEmpty(r);return;}this.writeWithContents(r,t);}asObject(){return this;}writeEmpty(r){const t=new Pe("{}");this.hasError&&t.setColor(r.context.colors.red).underline(),r.write(t);}writeWithContents(r,t){r.writeLine('{').withIndent(() => {r.writeJoined(Cr,[...t,...this.suggestions]).newLine();}),r.write('}'),this.hasError&&r.afterNextNewline(() => {r.writeLine(r.context.colors.red('~'.repeat(this.getPrintWidth())));});}};let Q=class extends ze{constructor(t){super();this.text=t;}getPrintWidth(){return this.text.length;}write(t){const n=new Pe(this.text);this.hasError&&n.underline().setColor(t.context.colors.red),t.write(n);}asObject(){}};let pt=class{fields=[];addField(r,t){return this.fields.push({write(n){const{green:i,dim:o}=n.context.colors;n.write(i(o(`${r}: ${t}`))).addMarginSymbol(i(o('+')));}}),this;}write(r){const{colors:{green:t}}=r.context;r.writeLine(t('{')).withIndent(() => {r.writeJoined(Cr,this.fields).newLine();}).write(t('}')).addMarginSymbol(t('+'));}};function Sn(e,r,t){switch(e.kind){case'MutuallyExclusiveFields':Ad(e,r);break;case'IncludeOnScalar':Cd(e,r);break;case'EmptySelection':Id(e,r,t);break;case'UnknownSelectionField':_d(e,r);break;case'InvalidSelectionValue':Nd(e,r);break;case'UnknownArgument':Ld(e,r);break;case'UnknownInputField':Fd(e,r);break;case'RequiredArgumentMissing':Md(e,r);break;case'InvalidArgumentType':$d(e,r);break;case'InvalidArgumentValue':qd(e,r);break;case'ValueTooLarge':Vd(e,r);break;case'SomeFieldsMissing':jd(e,r);break;case'TooManyFieldsGiven':Bd(e,r);break;case'Union':na(e,r,t);break;default:throw new Error('not implemented: '+e.kind);}}function Ad(e,r){const t=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();t&&(t.getField(e.firstField)?.markAsError(),t.getField(e.secondField)?.markAsError()),r.addErrorMessage(n => `Please ${n.bold('either')} use ${n.green(`\`${e.firstField}\``)} or ${n.green(`\`${e.secondField}\``)}, but ${n.red('not both')} at the same time.`);}function Cd(e,r){const[t,n]=Or(e.selectionPath),i=e.outputType,o=r.arguments.getDeepSelectionParent(t)?.value;if(o&&(o.getField(n)?.markAsError(),i))for(const s of i.fields)s.isRelation&&o.addSuggestion(new le(s.name,'true'));r.addErrorMessage(s => {let a=`Invalid scalar field ${s.red(`\`${n}\``)} for ${s.bold('include')} statement`;return i?a+=` on model ${s.bold(i.name)}. ${dt(s)}`:a+='.',a+=`
Note that ${s.bold('include')} statements only accept relation fields.`,a;});}function Id(e,r,t){const n=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();if(n){const i=n.getField("omit")?.value.asObject();if(i){Dd(e,r,i);return;}if(n.hasField('select')){Od(e,r);return;}}if(t?.[We(e.outputType.name)]){kd(e,r);return;}r.addErrorMessage(() => `Unknown field at "${e.selectionPath.join('.')} selection"`);}function Dd(e,r,t){t.removeAllFields();for(const n of e.outputType.fields)t.addSuggestion(new le(n.name,'false'));r.addErrorMessage(n => `The ${n.red('omit')} statement includes every field of the model ${n.bold(e.outputType.name)}. At least one field must be included in the result`);}function Od(e,r){const t=e.outputType,n=r.arguments.getDeepSelectionParent(e.selectionPath)?.value,i=n?.isEmpty()??!1;n&&(n.removeAllFields(),pa(n,t)),r.addErrorMessage(o => i?`The ${o.red('`select`')} statement for type ${o.bold(t.name)} must not be empty. ${dt(o)}`:`The ${o.red('`select`')} statement for type ${o.bold(t.name)} needs ${o.bold('at least one truthy value')}.`);}function kd(e,r){const t=new pt;for(const i of e.outputType.fields)i.isRelation||t.addField(i.name,'false');const n=new le("omit",t).makeRequired();if(e.selectionPath.length===0)r.arguments.addSuggestion(n);else{const[i,o]=Or(e.selectionPath),a=r.arguments.getDeepSelectionParent(i)?.value.asObject()?.getField(o);if(a){const l=a?.value.asObject()??new Dr;l.addSuggestion(n),a.value=l;}}r.addErrorMessage(i => `The global ${i.red('omit')} configuration excludes every field of the model ${i.bold(e.outputType.name)}. At least one field must be included in the result`);}function _d(e,r){const t=da(e.selectionPath,r);if(t.parentKind!=='unknown'){t.field.markAsError();const n=t.parent;switch(t.parentKind){case'select':pa(n,e.outputType);break;case'include':Ud(n,e.outputType);break;case'omit':Gd(n,e.outputType);break;}}r.addErrorMessage(n => {const i=[`Unknown field ${n.red(`\`${t.fieldName}\``)}`];return t.parentKind!=='unknown'&&i.push(`for ${n.bold(t.parentKind)} statement`),i.push(`on model ${n.bold(`\`${e.outputType.name}\``)}.`),i.push(dt(n)),i.join(' ');});}function Nd(e,r){const t=da(e.selectionPath,r);t.parentKind!=='unknown'&&t.field.value.markAsError(),r.addErrorMessage(n => `Invalid value for selection field \`${n.red(t.fieldName)}\`: ${e.underlyingError}`);}function Ld(e,r){const t=e.argumentPath[0],n=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();n&&(n.getField(t)?.markAsError(),Qd(n,e.arguments)),r.addErrorMessage(i => ua(i,t,e.arguments.map(o => o.name)));}function Fd(e,r){const[t,n]=Or(e.argumentPath),i=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();if(i){i.getDeepField(e.argumentPath)?.markAsError();const o=i.getDeepFieldValue(t)?.asObject();o&&ma(o,e.inputType);}r.addErrorMessage(o => ua(o,n,e.inputType.fields.map(s => s.name)));}function ua(e,r,t){const n=[`Unknown argument \`${e.red(r)}\`.`],i=Jd(r,t);return i&&n.push(`Did you mean \`${e.green(i)}\`?`),t.length>0&&n.push(dt(e)),n.join(' ');}function Md(e,r){let t;r.addErrorMessage(l => t?.value instanceof Q&&t.value.text==='null'?`Argument \`${l.green(o)}\` must not be ${l.red('null')}.`:`Argument \`${l.green(o)}\` is missing.`);const n=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();if(!n)return;const[i,o]=Or(e.argumentPath),s=new pt,a=n.getDeepFieldValue(i)?.asObject();if(a){if(t=a.getField(o),t&&a.removeField(o),e.inputTypes.length===1&&e.inputTypes[0].kind==='object'){for(const l of e.inputTypes[0].fields)s.addField(l.name,l.typeNames.join(' | '));a.addSuggestion(new le(o,s).makeRequired());}else{const l=e.inputTypes.map(ca).join(" | ");a.addSuggestion(new le(o,l).makeRequired());}if(e.dependentArgumentPath){n.getDeepField(e.dependentArgumentPath)?.markAsError();const[,l]=Or(e.dependentArgumentPath);r.addErrorMessage(u => `Argument \`${u.green(o)}\` is required because argument \`${u.green(l)}\` was provided.`);}}}function ca(e){return e.kind==='list'?`${ca(e.elementType)}[]`:e.name;}function $d(e,r){const t=e.argument.name,n=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();n&&n.getDeepFieldValue(e.argumentPath)?.markAsError(),r.addErrorMessage(i => {const o=In("or",e.argument.typeNames.map(s=>i.green(s)));return`Argument \`${i.bold(t)}\`: Invalid value provided. Expected ${o}, provided ${i.red(e.inferredType)}.`;});}function qd(e,r){const t=e.argument.name,n=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();n&&n.getDeepFieldValue(e.argumentPath)?.markAsError(),r.addErrorMessage(i => {const o=[`Invalid value for argument \`${i.bold(t)}\``];if(e.underlyingError&&o.push(`: ${e.underlyingError}`),o.push('.'),e.argument.typeNames.length>0){const s=In("or",e.argument.typeNames.map(a=>i.green(a)));o.push(` Expected ${s}.`);}return o.join('');});}function Vd(e,r){let t=e.argument.name,n=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject(),i;if(n){const s=n.getDeepField(e.argumentPath)?.value;s?.markAsError(),s instanceof Q&&(i=s.text);}r.addErrorMessage(o => {const s=["Unable to fit value"];return i&&s.push(o.red(i)),s.push(`into a 64-bit signed integer for field \`${o.bold(t)}\``),s.join(' ');});}function jd(e,r){const t=e.argumentPath[e.argumentPath.length-1],n=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();if(n){const i=n.getDeepFieldValue(e.argumentPath)?.asObject();i&&ma(i,e.inputType);}r.addErrorMessage(i => {const o=[`Argument \`${i.bold(t)}\` of type ${i.bold(e.inputType.name)} needs`];return e.constraints.minFieldCount===1?e.constraints.requiredFields?o.push(`${i.green('at least one of')} ${In('or',e.constraints.requiredFields.map(s => `\`${i.bold(s)}\``))} arguments.`):o.push(`${i.green('at least one')} argument.`):o.push(`${i.green(`at least ${e.constraints.minFieldCount}`)} arguments.`),o.push(dt(i)),o.join(' ');});}function Bd(e,r){let t=e.argumentPath[e.argumentPath.length-1],n=r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject(),i=[];if(n){const o=n.getDeepFieldValue(e.argumentPath)?.asObject();o&&(o.markAsError(),i=Object.keys(o.getFields()));}r.addErrorMessage(o => {const s=[`Argument \`${o.bold(t)}\` of type ${o.bold(e.inputType.name)} needs`];return e.constraints.minFieldCount===1&&e.constraints.maxFieldCount==1?s.push(`${o.green('exactly one')} argument,`):e.constraints.maxFieldCount==1?s.push(`${o.green('at most one')} argument,`):s.push(`${o.green(`at most ${e.constraints.maxFieldCount}`)} arguments,`),s.push(`but you provided ${In('and',i.map(a => o.red(a)))}. Please choose`),e.constraints.maxFieldCount===1?s.push('one.'):s.push(`${e.constraints.maxFieldCount}.`),s.join(' ');});}function pa(e,r){for(const t of r.fields)e.hasField(t.name)||e.addSuggestion(new le(t.name,'true'));}function Ud(e,r){for(const t of r.fields)t.isRelation&&!e.hasField(t.name)&&e.addSuggestion(new le(t.name,'true'));}function Gd(e,r){for(const t of r.fields)!e.hasField(t.name)&&!t.isRelation&&e.addSuggestion(new le(t.name,'true'));}function Qd(e,r){for(const t of r)e.hasField(t.name)||e.addSuggestion(new le(t.name,t.typeNames.join(' | ')));}function da(e,r){const[t,n]=Or(e),i=r.arguments.getDeepSubSelectionValue(t)?.asObject();if(!i)return{parentKind:'unknown',fieldName:n};let o=i.getFieldValue('select')?.asObject(),s=i.getFieldValue('include')?.asObject(),a=i.getFieldValue('omit')?.asObject(),l=o?.getField(n);return o&&l?{parentKind:'select',parent:o,field:l,fieldName:n}:(l=s?.getField(n),s&&l?{parentKind:'include',field:l,parent:s,fieldName:n}:(l=a?.getField(n),a&&l?{parentKind:'omit',field:l,parent:a,fieldName:n}:{parentKind:'unknown',fieldName:n}));}function ma(e,r){if(r.kind==='object')for(const t of r.fields)e.hasField(t.name)||e.addSuggestion(new le(t.name,t.typeNames.join(' | ')));}function Or(e){const r=[...e],t=r.pop();if(!t)throw new Error('unexpected empty path');return[r,t];}function dt({green:e,enabled:r}){return'Available options are '+(r?`listed in ${e('green')}`:'marked with ?')+'.'}function In(e,r){if(r.length===1)return r[0];const t=[...r],n=t.pop();return`${t.join(', ')} ${e} ${n}`;}let Wd=3;function Jd(e,r){let t=1/0,n;for(const i of r){const o=(0,la.default)(e,i);o>Wd||o<t&&(t=o,n=i);}return n;}let mt=class{modelName;name;typeName;isList;isEnum;constructor(r,t,n,i,o){this.modelName=r,this.name=t,this.typeName=n,this.isList=i,this.isEnum=o;}_toGraphQLInputType(){const r=this.isList?"List":"",t=this.isEnum?"Enum":"";return`${r}${t}${this.typeName}FieldRefInput<${this.modelName}>`;}};function kr(e){return e instanceof mt;}let Dn=Symbol(),Yi=new WeakMap,Me=class{constructor(r){r===Dn?Yi.set(this,`Prisma.${this._getName()}`):Yi.set(this,`new Prisma.${this._getNamespace()}.${this._getName()}()`);}_getName(){return this.constructor.name;}toString(){return Yi.get(this);}},ft=class extends Me{_getNamespace(){return'NullTypes'}},gt=class extends ft{#e;};zi(gt,'DbNull');let ht=class extends ft{#e;};zi(ht,'JsonNull');let yt=class extends ft{#e;};zi(yt,'AnyNull');var On={classes:{DbNull:gt,JsonNull:ht,AnyNull:yt},instances:{DbNull:new gt(Dn),JsonNull:new ht(Dn),AnyNull:new yt(Dn)}};function zi(e,r){Object.defineProperty(e,'name',{value:r,configurable:!0});}let fa=': ',kn=class{constructor(r,t){this.name=r;this.value=t;}hasError=!1;markAsError(){this.hasError=!0;}getPrintWidth(){return this.name.length+this.value.getPrintWidth()+fa.length;}write(r){const t=new Pe(this.name);this.hasError&&t.underline().setColor(r.context.colors.red),r.write(t).write(fa).write(this.value);}};let Zi=class{arguments;errorMessages=[];constructor(r){this.arguments=r;}write(r){r.write(this.arguments);}addErrorMessage(r){this.errorMessages.push(r);}renderAllMessages(r){return this.errorMessages.map(t => t(r)).join(`
`);}};function _r(e){return new Zi(ga(e));}function ga(e){const r=new Dr;for(const[t,n]of Object.entries(e)){const i=new kn(t,ha(n));r.addField(i);}return r;}function ha(e){if(typeof e=='string')return new Q(JSON.stringify(e));if(typeof e=='number'||typeof e=='boolean')return new Q(String(e));if(typeof e=='bigint')return new Q(`${e}n`);if(e===null)return new Q('null');if(e===void 0)return new Q('undefined');if(Sr(e))return new Q(`new Prisma.Decimal("${e.toFixed()}")`);if(e instanceof Uint8Array)return Buffer.isBuffer(e)?new Q(`Buffer.alloc(${e.byteLength})`):new Q(`new Uint8Array(${e.byteLength})`);if(e instanceof Date){const r=mn(e)?e.toISOString():"Invalid Date";return new Q(`new Date("${r}")`);}return e instanceof Me?new Q(`Prisma.${e._getName()}`):kr(e)?new Q(`prisma.${We(e.modelName)}.$fields.${e.name}`):Array.isArray(e)?Kd(e):typeof e=='object'?ga(e):new Q(Object.prototype.toString.call(e));}function Kd(e){const r=new Ir;for(const t of e)r.addItem(ha(t));return r;}function _n(e,r){const t=r==="pretty"?aa:Cn,n=e.renderAllMessages(t),i=new Ar(0,{colors:t}).write(e).toString();return{message:n,args:i};}function Nn({args:e,errors:r,errorFormat:t,callsite:n,originalMethod:i,clientVersion:o,globalOmit:s}){const a=_r(e);for(const p of r)Sn(p,a,s);const{message:l,args:u}=_n(a,t),c=Tn({message:l,callsite:n,originalMethod:i,showColors:t==="pretty",callArguments:u});throw new Z(c,{clientVersion:o});}function Te(e){return e.replace(/^./,r => r.toLowerCase());}function ba(e,r,t){const n=Te(t);return!r.result||!(r.result.$allModels||r.result[n])?e:Hd({...e,...ya(r.name,e,r.result.$allModels),...ya(r.name,e,r.result[n])});}function Hd(e){const r=new we,t=(n,i)=>r.getOrCreate(n,()=>i.has(n)?[n]:(i.add(n),e[n]?e[n].needs.flatMap(o=>t(o,i)):[n]));return pn(e,n => ({...n,needs:t(n.name,new Set)}));}function ya(e,r,t){return t?pn(t,({needs:n,compute:i},o) => ({name:o,needs:n?Object.keys(n).filter(s => n[s]):[],compute:Yd(r,o,i)})):{};}function Yd(e,r,t){const n=e?.[r]?.compute;return n?i => t({...i,[r]:n(i)}):t;}function Ea(e,r){if(!r)return e;const t={...e};for(const n of Object.values(r))if(e[n.name])for(const i of n.needs)t[i]=!0;return t;}function wa(e,r){if(!r)return e;const t={...e};for(const n of Object.values(r))if(!e[n.name])for(const i of n.needs)delete t[i];return t;}let Ln=class{constructor(r,t){this.extension=r;this.previous=t;}computedFieldsCache=new we;modelExtensionsCache=new we;queryCallbacksCache=new we;clientExtensions=lt(() => this.extension.client?{...this.previous?.getAllClientExtensions(),...this.extension.client}:this.previous?.getAllClientExtensions());batchCallbacks=lt(() => {const r=this.previous?.getAllBatchQueryCallbacks()??[],t=this.extension.query?.$__internalBatch;return t?r.concat(t):r;});getAllComputedFields(r){return this.computedFieldsCache.getOrCreate(r,() => ba(this.previous?.getAllComputedFields(r),this.extension,r));}getAllClientExtensions(){return this.clientExtensions.get();}getAllModelExtensions(r){return this.modelExtensionsCache.getOrCreate(r,() => {const t=Te(r);return!this.extension.model||!(this.extension.model[t]||this.extension.model.$allModels)?this.previous?.getAllModelExtensions(r):{...this.previous?.getAllModelExtensions(r),...this.extension.model.$allModels,...this.extension.model[t]};});}getAllQueryCallbacks(r,t){return this.queryCallbacksCache.getOrCreate(`${r}:${t}`,() => {const n=this.previous?.getAllQueryCallbacks(r,t)??[],i=[],o=this.extension.query;return!o||!(o[r]||o.$allModels||o[t]||o.$allOperations)?n:(o[r]!==void 0&&(o[r][t]!==void 0&&i.push(o[r][t]),o[r].$allOperations!==void 0&&i.push(o[r].$allOperations)),r!=='$none'&&o.$allModels!==void 0&&(o.$allModels[t]!==void 0&&i.push(o.$allModels[t]),o.$allModels.$allOperations!==void 0&&i.push(o.$allModels.$allOperations)),o[t]!==void 0&&i.push(o[t]),o.$allOperations!==void 0&&i.push(o.$allOperations),n.concat(i));});}getAllBatchQueryCallbacks(){return this.batchCallbacks.get();}},Nr=class e{constructor(r){this.head=r;}static empty(){return new e;}static single(r){return new e(new Ln(r));}isEmpty(){return this.head===void 0;}append(r){return new e(new Ln(r,this.head));}getAllComputedFields(r){return this.head?.getAllComputedFields(r);}getAllClientExtensions(){return this.head?.getAllClientExtensions();}getAllModelExtensions(r){return this.head?.getAllModelExtensions(r);}getAllQueryCallbacks(r,t){return this.head?.getAllQueryCallbacks(r,t)??[];}getAllBatchQueryCallbacks(){return this.head?.getAllBatchQueryCallbacks()??[];}};let Fn=class{constructor(r){this.name=r;}};function xa(e){return e instanceof Fn;}function va(e){return new Fn(e);}var Pa=Symbol(),bt=class{constructor(r){if(r!==Pa)throw new Error('Skip instance can not be constructed directly');}ifUndefined(r){return r===void 0?Mn:r;}},Mn=new bt(Pa);function Se(e){return e instanceof bt;}let zd={findUnique:'findUnique',findUniqueOrThrow:'findUniqueOrThrow',findFirst:'findFirst',findFirstOrThrow:'findFirstOrThrow',findMany:'findMany',count:'aggregate',create:'createOne',createMany:'createMany',createManyAndReturn:'createManyAndReturn',update:'updateOne',updateMany:'updateMany',updateManyAndReturn:'updateManyAndReturn',upsert:'upsertOne',delete:'deleteOne',deleteMany:'deleteMany',executeRaw:'executeRaw',queryRaw:'queryRaw',aggregate:'aggregate',groupBy:'groupBy',runCommandRaw:'runCommandRaw',findRaw:'findRaw',aggregateRaw:'aggregateRaw'},Ta='explicitly `undefined` values are not allowed';function $n({modelName:e,action:r,args:t,runtimeDataModel:n,extensions:i=Nr.empty(),callsite:o,clientMethod:s,errorFormat:a,clientVersion:l,previewFeatures:u,globalOmit:c}){const p=new Xi({runtimeDataModel:n,modelName:e,action:r,rootArgs:t,callsite:o,extensions:i,selectionPath:[],argumentPath:[],originalMethod:s,errorFormat:a,clientVersion:l,previewFeatures:u,globalOmit:c});return{modelName:e,action:zd[r],query:Et(t,p)};}function Et({select:e,include:r,...t}={},n){const i=t.omit;return delete t.omit,{arguments:Ra(t,n),selection:Zd(e,r,i,n)};}function Zd(e,r,t,n){return e?(r?n.throwValidationError({kind:'MutuallyExclusiveFields',firstField:'include',secondField:'select',selectionPath:n.getSelectionPath()}):t&&n.throwValidationError({kind:'MutuallyExclusiveFields',firstField:'omit',secondField:'select',selectionPath:n.getSelectionPath()}),tm(e,n)):Xd(n,r,t);}function Xd(e,r,t){const n={};return e.modelOrType&&!e.isRawAction()&&(n.$composites=!0,n.$scalars=!0),r&&em(n,r,e),rm(n,t,e),n;}function em(e,r,t){for(const[n,i]of Object.entries(r)){if(Se(i))continue;const o=t.nestSelection(n);if(eo(i,o),i===!1||i===void 0){e[n]=!1;continue;}const s=t.findField(n);if(s&&s.kind!=='object'&&t.throwValidationError({kind:'IncludeOnScalar',selectionPath:t.getSelectionPath().concat(n),outputType:t.getOutputTypeDescription()}),s){e[n]=Et(i===!0?{}:i,o);continue;}if(i===!0){e[n]=!0;continue;}e[n]=Et(i,o);}}function rm(e,r,t){const n=t.getComputedFields(),i={...t.getGlobalOmit(),...r},o=wa(i,n);for(const[s,a]of Object.entries(o)){if(Se(a))continue;eo(a,t.nestSelection(s));const l=t.findField(s);n?.[s]&&!l||(e[s]=!a);}}function tm(e,r){const t={},n=r.getComputedFields(),i=Ea(e,n);for(const[o,s]of Object.entries(i)){if(Se(s))continue;const a=r.nestSelection(o);eo(s,a);const l=r.findField(o);if(!(n?.[o]&&!l)){if(s===!1||s===void 0||Se(s)){t[o]=!1;continue;}if(s===!0){l?.kind==='object'?t[o]=Et({},a):t[o]=!0;continue;}t[o]=Et(s,a);}}return t;}function Sa(e,r){if(e===null)return null;if(typeof e=='string'||typeof e=='number'||typeof e=='boolean')return e;if(typeof e=='bigint')return{$type:'BigInt',value:String(e)};if(vr(e)){if(mn(e))return{$type:'DateTime',value:e.toISOString()};r.throwValidationError({kind:'InvalidArgumentValue',selectionPath:r.getSelectionPath(),argumentPath:r.getArgumentPath(),argument:{name:r.getArgumentName(),typeNames:['Date']},underlyingError:'Provided Date object is invalid'});}if(xa(e))return{$type:'Param',value:e.name};if(kr(e))return{$type:'FieldRef',value:{_ref:e.name,_container:e.modelName}};if(Array.isArray(e))return nm(e,r);if(ArrayBuffer.isView(e)){const{buffer:t,byteOffset:n,byteLength:i}=e;return{$type:'Bytes',value:Buffer.from(t,n,i).toString('base64')};}if(im(e))return e.values;if(Sr(e))return{$type:'Decimal',value:e.toFixed()};if(e instanceof Me){if(e!==On.instances[e._getName()])throw new Error('Invalid ObjectEnumValue');return{$type:'Enum',value:e._getName()};}if(om(e))return e.toJSON();if(typeof e=='object')return Ra(e,r);r.throwValidationError({kind:'InvalidArgumentValue',selectionPath:r.getSelectionPath(),argumentPath:r.getArgumentPath(),argument:{name:r.getArgumentName(),typeNames:[]},underlyingError:`We could not serialize ${Object.prototype.toString.call(e)} value. Serialize the object to JSON or implement a ".toJSON()" method on it`});}function Ra(e,r){if(e.$type)return{$type:'Raw',value:e};const t={};for(const n in e){const i=e[n],o=r.nestArgument(n);Se(i)||(i!==void 0?t[n]=Sa(i,o):r.isPreviewFeatureOn('strictUndefinedChecks')&&r.throwValidationError({kind:'InvalidArgumentValue',argumentPath:o.getArgumentPath(),selectionPath:r.getSelectionPath(),argument:{name:r.getArgumentName(),typeNames:[]},underlyingError:Ta}));}return t;}function nm(e,r){const t=[];for(let n=0;n<e.length;n++){const i=r.nestArgument(String(n)),o=e[n];if(o===void 0||Se(o)){const s=o===void 0?"undefined":"Prisma.skip";r.throwValidationError({kind:'InvalidArgumentValue',selectionPath:i.getSelectionPath(),argumentPath:i.getArgumentPath(),argument:{name:`${r.getArgumentName()}[${n}]`,typeNames:[]},underlyingError:`Can not use \`${s}\` value within array. Use \`null\` or filter out \`${s}\` values`});}t.push(Sa(o,i));}return t;}function im(e){return typeof e=='object'&&e!==null&&e.__prismaRawParameters__===!0;}function om(e){return typeof e=='object'&&e!==null&&typeof e.toJSON=='function'}function eo(e,r){e===void 0&&r.isPreviewFeatureOn('strictUndefinedChecks')&&r.throwValidationError({kind:'InvalidSelectionValue',selectionPath:r.getSelectionPath(),underlyingError:Ta});}var Xi=class e{constructor(r){this.params=r;this.params.modelName&&(this.modelOrType=this.params.runtimeDataModel.models[this.params.modelName]??this.params.runtimeDataModel.types[this.params.modelName]);}modelOrType;throwValidationError(r){Nn({errors:[r],originalMethod:this.params.originalMethod,args:this.params.rootArgs??{},callsite:this.params.callsite,errorFormat:this.params.errorFormat,clientVersion:this.params.clientVersion,globalOmit:this.params.globalOmit});}getSelectionPath(){return this.params.selectionPath;}getArgumentPath(){return this.params.argumentPath;}getArgumentName(){return this.params.argumentPath[this.params.argumentPath.length-1];}getOutputTypeDescription(){if(!(!this.params.modelName||!this.modelOrType))return{name:this.params.modelName,fields:this.modelOrType.fields.map(r => ({name:r.name,typeName:'boolean',isRelation:r.kind==='object'}))};}isRawAction(){return['executeRaw','queryRaw','runCommandRaw','findRaw','aggregateRaw'].includes(this.params.action);}isPreviewFeatureOn(r){return this.params.previewFeatures.includes(r);}getComputedFields(){if(this.params.modelName)return this.params.extensions.getAllComputedFields(this.params.modelName);}findField(r){return this.modelOrType?.fields.find(t => t.name===r);}nestSelection(r){const t=this.findField(r),n=t?.kind==="object"?t.type:void 0;return new e({...this.params,modelName:n,selectionPath:this.params.selectionPath.concat(r)});}getGlobalOmit(){return this.params.modelName&&this.shouldApplyGlobalOmit()?this.params.globalOmit?.[We(this.params.modelName)]??{}:{};}shouldApplyGlobalOmit(){switch(this.params.action){case'findFirst':case'findFirstOrThrow':case'findUniqueOrThrow':case'findMany':case'upsert':case'findUnique':case'createManyAndReturn':case'create':case'update':case'updateManyAndReturn':case'delete':return!0;case'executeRaw':case'aggregateRaw':case'runCommandRaw':case'findRaw':case'createMany':case'deleteMany':case'groupBy':case'updateMany':case'count':case'aggregate':case'queryRaw':return!1;default:ar(this.params.action,'Unknown action');}}nestArgument(r){return new e({...this.params,argumentPath:this.params.argumentPath.concat(r)});}};function Aa(e){if(!e._hasPreviewFlag('metrics'))throw new Z('`metrics` preview feature must be enabled in order to access metrics API',{clientVersion:e._clientVersion});}var Lr=class{_client;constructor(r){this._client=r;}prometheus(r){return Aa(this._client),this._client._engine.metrics({format:'prometheus',...r});}json(r){return Aa(this._client),this._client._engine.metrics({format:'json',...r});}};function Ca(e,r){const t=lt(()=>sm(r));Object.defineProperty(e,'dmmf',{get:() => t.get()});}function sm(e){return{datamodel:{models:ro(e.models),enums:ro(e.enums),types:ro(e.types)}};}function ro(e){return Object.entries(e).map(([r,t]) => ({name:r,...t}));}let to=new WeakMap,qn='$$PrismaTypedSql',wt=class{constructor(r,t){to.set(this,{sql:r,values:t}),Object.defineProperty(this,qn,{value:qn});}get sql(){return to.get(this).sql;}get values(){return to.get(this).values;}};function Ia(e){return(...r) => new wt(e,r);}function Vn(e){return e!=null&&e[qn]===qn;}let cu=O(Ti());let pu=require('node:async_hooks'),du=require('node:events'),mu=O(require('node:fs')),ri=O(require('node:path'));var ie=class e{constructor(r,t){if(r.length-1!==t.length)throw r.length===0?new TypeError('Expected at least 1 string'):new TypeError(`Expected ${r.length} strings to have ${r.length-1} values`);const n=t.reduce((s,a)=>s+(a instanceof e?a.values.length:1),0);this.values=new Array(n),this.strings=new Array(n+1),this.strings[0]=r[0];let i=0,o=0;for(;i<t.length;){const s=t[i++],a=r[i];if(s instanceof e){this.strings[o]+=s.strings[0];let l=0;for(;l<s.values.length;)this.values[o++]=s.values[l++],this.strings[o]=s.strings[l];this.strings[o]+=a;}else this.values[o++]=s,this.strings[o]=a;}}get sql(){let r=this.strings.length,t=1,n=this.strings[0];for(;t<r;)n+=`?${this.strings[t++]}`;return n;}get statement(){let r=this.strings.length,t=1,n=this.strings[0];for(;t<r;)n+=`:${t}${this.strings[t++]}`;return n;}get text(){let r=this.strings.length,t=1,n=this.strings[0];for(;t<r;)n+=`$${t}${this.strings[t++]}`;return n;}inspect(){return{sql:this.sql,statement:this.statement,text:this.text,values:this.values};}};function Da(e,r=',',t='',n=''){if(e.length===0)throw new TypeError('Expected `join([])` to be called with an array of multiple elements, but got an empty array');return new ie([t,...Array(e.length-1).fill(r),n],e);}function no(e){return new ie([e],[]);}var Oa=no('');function io(e,...r){return new ie(e,r);}function xt(e){return{getKeys(){return Object.keys(e);},getPropertyValue(r){return e[r];}};}function re(e,r){return{getKeys(){return[e];},getPropertyValue(){return r();}};}function lr(e){const r=new we;return{getKeys(){return e.getKeys();},getPropertyValue(t){return r.getOrCreate(t,() => e.getPropertyValue(t));},getPropertyDescriptor(t){return e.getPropertyDescriptor?.(t);}};}let jn={enumerable:!0,configurable:!0,writable:!0};function Bn(e){const r=new Set(e);return{getPrototypeOf:() => Object.prototype,getOwnPropertyDescriptor:() => jn,has:(t,n) => r.has(n),set:(t,n,i) => r.add(n)&&Reflect.set(t,n,i),ownKeys:() => [...r]};}let ka=Symbol.for('nodejs.util.inspect.custom');function he(e,r){const t=am(r),n=new Set,i=new Proxy(e,{get(o,s){if(n.has(s))return o[s];let a=t.get(s);return a?a.getPropertyValue(s):o[s]},has(o,s){if(n.has(s))return!0;let a=t.get(s);return a?a.has?.(s)??!0:Reflect.has(o,s)},ownKeys(o){let s=_a(Reflect.ownKeys(o),t),a=_a(Array.from(t.keys()),t);return[...new Set([...s,...a,...n])]},set(o,s,a){return t.get(s)?.getPropertyDescriptor?.(s)?.writable===!1?!1:(n.add(s),Reflect.set(o,s,a))},getOwnPropertyDescriptor(o,s){let a=Reflect.getOwnPropertyDescriptor(o,s);if(a&&!a.configurable)return a;let l=t.get(s);return l?l.getPropertyDescriptor?{...jn,...l?.getPropertyDescriptor(s)}:jn:a},defineProperty(o,s,a){return n.add(s),Reflect.defineProperty(o,s,a)},getPrototypeOf:()=>Object.prototype});return i[ka]=function(){const o={...this};return delete o[ka],o;},i;}function am(e){const r=new Map;for(const t of e){const n=t.getKeys();for(const i of n)r.set(i,t);}return r;}function _a(e,r){return e.filter(t => r.get(t)?.has?.(t)??!0);}function Fr(e){return{getKeys(){return e;},has(){return!1;},getPropertyValue(){}};}function Mr(e,r){return{batch:e,transaction:r?.kind==='batch'?{isolationLevel:r.options.isolationLevel}:void 0};}function Na(e){if(e===void 0)return'';const r=_r(e);return new Ar(0,{colors:Cn}).write(r).toString();}let lm='P2037';function $r({error:e,user_facing_error:r},t,n){return r.error_code?new z(um(r,n),{code:r.error_code,clientVersion:t,meta:r.meta,batchRequestIdx:r.batch_request_idx}):new V(e,{clientVersion:t,batchRequestIdx:r.batch_request_idx});}function um(e,r){let t=e.message;return(r==='postgresql'||r==='postgres'||r==='mysql')&&e.error_code===lm&&(t+=`
...
${Um(e)}`;}function Um(e){let{generator:r,generatorBinaryTargets:t,runtimeBinaryTarget:n}=e,i={fromEnvVar:null,value:n},o=[...t,i];return ki({...r,binaryTargets:o});}function Xe(e){const{runtimeBinaryTarget:r}=e;return`Prisma Client could not locate the Query Engine for runtime "${r}".`;}function er(e){const{searchedLocations:r}=e;return`The following locations have been searched:
${[...new Set(r)].map(i => `  ${i}`).join(`
`)}`;}function ll(e){const{runtimeBinaryTarget:r}=e;return`${Xe(e)}
...
Please help us by answering a few questions: https://pris.ly/${e}`;}function Jn(e){const{errorStack:r}=e;return r?.match(/\/\.next|\/next@|\/next\//)?`
...
${er(e)}`;}function pl(e){const{queryEngineName:r}=e;return`${Xe(e)}${Jn(e)}
...
${er(e)}`;}let Gm=N('prisma:client:engines:resolveEnginePath'),Qm=() => new RegExp('runtime[\\\\/]library\\.m?js$');async function ml(e,r){const t={binary:process.env.PRISMA_QUERY_ENGINE_BINARY,library:process.env.PRISMA_QUERY_ENGINE_LIBRARY}[e]??r.prismaPath;if(t!==void 0)return t;const{enginePath:n,searchedLocations:i}=await Wm(e,r);if(Gm('enginePath',n),n!==void 0&&e==='binary'&&Ri(n),n!==void 0)return r.prismaPath=n;let o=await ir(),s=r.generator?.binaryTargets??[],a=s.some(d => d.native),l=!s.some(d => d.value===o),u=__filename.match(Qm())===null,c={searchedLocations:i,generatorBinaryTargets:s,generator:r.generator,runtimeBinaryTarget:o,queryEngineName:fl(e,o),expectedLocation:St.default.relative(process.cwd(),r.dirname),errorStack:new Error().stack},p;throw a&&l?p=cl(c):l?p=ll(c):u?p=ul(c):p=pl(c),new P(p,r.clientVersion);}async function Wm(e,r){const t=await ir(),n=[],i=[r.dirname,St.default.resolve(__dirname,".."),r.generator?.output?.value??__dirname,St.default.resolve(__dirname,"../../../.prisma/client"),"/tmp/prisma-engines",r.cwd];__filename.includes('resolveEnginePath')&&i.push(ms());for(const o of i){const s=fl(e,t),a=St.default.join(o,s);if(n.push(o),dl.default.existsSync(a))return{enginePath:a,searchedLocations:n};}return{enginePath:void 0,searchedLocations:n};}function fl(e,r){return e==='library'?Gt(r,'fs'):`query-engine-${r}${r==='windows'?'.exe':''}`;}function gl(e){return e?e.replace(/".*"/g,'"X"').replace(/[\s:\[]([+-]?([0-9]*[.])?[0-9]+)/g,r => `${r[0]}5`):''}function hl(e){return e.split(`
`
    )
    .map(r =>
      r
...
`);}let yl=O(Os());function bl({title:e,user:r='prisma',repo:t='prisma',template:n='bug_report.yml',body:i}){return(0,yl.default)({user:r,repo:t,template:n,title:e,body:i});}function El({version:e,binaryTarget:r,title:t,description:n,engineVersion:i,database:o,query:s}){const a=Bo(6e3-(s?.length??0)),l=hl(wr(a)),u=n?`# Description
\`\`\`
${n}
...
`;}function wl(e,r){throw new Error(r);}function Jm(e){return e!==null&&typeof e=='object'&&typeof e.$type=='string'}function Km(e,r){const t={};for(const n of Object.keys(e))t[n]=r(e[n],n);return t;}function Vr(e){return e===null?e:Array.isArray(e)?e.map(Vr):typeof e=='object'?Jm(e)?Hm(e):e.constructor!==null&&e.constructor.name!=='Object'?e:Km(e,Vr):e;}function Hm({$type:e,value:r}){switch(e){case'BigInt':return BigInt(r);case'Bytes':{const{buffer:t,byteOffset:n,byteLength:i}=Buffer.from(r,"base64");return new Uint8Array(t,n,i);}case'DateTime':return new Date(r);case'Decimal':return new Le(r);case'Json':return JSON.parse(r);default:wl(r,'Unknown tagged value');}}let xl='6.16.3';let zm=() => globalThis.process?.release?.name==='node',Zm=() => !!globalThis.Bun||!!globalThis.process?.versions?.bun,Xm=() => !!globalThis.Deno,ef=() => typeof globalThis.Netlify=='object',rf=() => typeof globalThis.EdgeRuntime=='object',tf=() => globalThis.navigator?.userAgent==='Cloudflare-Workers';function nf(){return[[ef,'netlify'],[rf,'edge-light'],[tf,'workerd'],[Xm,'deno'],[Zm,'bun'],[zm,'node']].flatMap(t => t[0]()?[t[1]]:[]).at(0)??''}let of={node:'Node.js',workerd:'Cloudflare Workers',deno:'Deno and Deno Deploy',netlify:'Netlify Edge Functions','edge-light':'Edge Runtime (Vercel Edge Functions, Vercel Edge Middleware, Next.js (Pages Router) Edge API Routes, Next.js (App Router) Edge Route Handlers or Next.js Middleware)'};function Kn(){const e=nf();return{id:e,prettyName:of[e]||e,isEdge:['workerd','deno','netlify','edge-light'].includes(e)};}function jr({inlineDatasources:e,overrideDatasources:r,env:t,clientVersion:n}){let i,o=Object.keys(e)[0],s=e[o]?.url,a=r[o]?.url;if(o===void 0?i=void 0:a?i=a:s?.value?i=s.value:s?.fromEnvVar&&(i=t[s.fromEnvVar]),s?.fromEnvVar!==void 0&&i===void 0)throw new P(`error: Environment variable not found: ${s.fromEnvVar}.`,n);if(i===void 0)throw new P('error: Missing URL environment variable, value, or override.',n);return i;}let Hn=class extends Error{clientVersion;cause;constructor(r,t){super(r),this.clientVersion=t.clientVersion,this.cause=t.cause;}get[Symbol.toStringTag](){return this.name;}};let oe=class extends Hn{isRetryable;constructor(r,t){super(r,t),this.isRetryable=t.isRetryable??!0;}};function R(e,r){return{...e,isRetryable:r};}let ur=class extends oe{name='InvalidDatasourceError';code='P6001';constructor(r,t){super(r,R(t,!1));}};x(ur,'InvalidDatasourceError');function vl(e){let r={clientVersion:e.clientVersion},t=Object.keys(e.inlineDatasources)[0],n=jr({inlineDatasources:e.inlineDatasources,overrideDatasources:e.overrideDatasources,clientVersion:e.clientVersion,env:{...e.env,...typeof process<'u'?process.env:{}}}),i;try{i=new URL(n);}catch{throw new ur(`Error validating datasource \`${t}\`: the URL must start with the protocol \`prisma://\``,r);}const{protocol:o,searchParams:s}=i;if(o!=='prisma:'&&o!==sn)throw new ur(`Error validating datasource \`${t}\`: the URL must start with the protocol \`prisma://\` or \`prisma+postgres://\``,r);const a=s.get("api_key");if(a===null||a.length<1)throw new ur(`Error validating datasource \`${t}\`: the URL must contain a valid API key`,r);let l=Ii(i)?'http:':'https:';process.env.TEST_CLIENT_ENGINE_REMOTE_EXECUTOR&&i.searchParams.has('use_http')&&(l='http:');const u=new URL(i.href.replace(o,l));return{apiKey:a,url:u};}let Pl=O(on()),Yn=class{apiKey;tracingHelper;logLevel;logQueries;engineHash;constructor({apiKey:r,tracingHelper:t,logLevel:n,logQueries:i,engineHash:o}){this.apiKey=r,this.tracingHelper=t,this.logLevel=n,this.logQueries=i,this.engineHash=o;}build({traceparent:r,transactionId:t}={}){const n={Accept:"application/json",Authorization:`Bearer ${this.apiKey}`,"Content-Type":"application/json","Prisma-Engine-Hash":this.engineHash,"Prisma-Engine-Version":Pl.enginesVersion};this.tracingHelper.isEnabled()&&(n.traceparent=r??this.tracingHelper.getTraceParent()),t&&(n['X-Transaction-Id']=t);const i=this.#e();return i.length>0&&(n['X-Capture-Telemetry']=i.join(', ')),n;}#e(){const r=[];return this.tracingHelper.isEnabled()&&r.push('tracing'),this.logLevel&&r.push(this.logLevel),this.logQueries&&r.push('query'),r;}};function sf(e){return e[0]*1e3+e[1]/1e6;}function po(e){return new Date(sf(e));}let Br=class extends oe{name='ForcedRetryError';code='P5001';constructor(r){super('This request must be retried',R(r,!0));}};x(Br,'ForcedRetryError');let cr=class extends oe{name='NotImplementedYetError';code='P5004';constructor(r,t){super(r,R(t,!1));}};x(cr,'NotImplementedYetError');let $=class extends oe{response;constructor(r,t){super(r,t),this.response=t.response;const n=this.response.headers.get("prisma-request-id");if(n){const i=`(The request id was: ${n})`;this.message=`${this.message} ${i}`}}};let pr=class extends ${name='SchemaMissingError';code='P5005';constructor(r){super('Schema needs to be uploaded',R(r,!0));}};x(pr,'SchemaMissingError');let mo='This request could not be understood by the server',Rt=class extends ${name='BadRequestError';code='P5000';constructor(r,t,n){super(t||mo,R(r,!1)),n&&(this.code=n);}};x(Rt,'BadRequestError');let At=class extends ${name='HealthcheckTimeoutError';code='P5013';logs;constructor(r,t){super('Engine not started: healthcheck timeout',R(r,!0)),this.logs=t;}};x(At,'HealthcheckTimeoutError');let Ct=class extends ${name='EngineStartupError';code='P5014';logs;constructor(r,t,n){super(t,R(r,!0)),this.logs=n;}};x(Ct,'EngineStartupError');let It=class extends ${name='EngineVersionNotSupportedError';code='P5012';constructor(r){super('Engine version is not supported',R(r,!1));}};x(It,'EngineVersionNotSupportedError');let fo='Request timed out',Dt=class extends ${name='GatewayTimeoutError';code='P5009';constructor(r,t=fo){super(t,R(r,!1));}};x(Dt,'GatewayTimeoutError');let af='Interactive transaction error',Ot=class extends ${name='InteractiveTransactionError';code='P5015';constructor(r,t=af){super(t,R(r,!1));}};x(Ot,'InteractiveTransactionError');let lf='Request parameters are invalid',kt=class extends ${name='InvalidRequestError';code='P5011';constructor(r,t=lf){super(t,R(r,!1));}};x(kt,'InvalidRequestError');let go='Requested resource does not exist',_t=class extends ${name='NotFoundError';code='P5003';constructor(r,t=go){super(t,R(r,!1));}};x(_t,'NotFoundError');let ho='Unknown server error',Ur=class extends ${name='ServerError';code='P5006';logs;constructor(r,t,n){super(t||ho,R(r,!0)),this.logs=n;}};x(Ur,'ServerError');let yo='Unauthorized, check your connection string',Nt=class extends ${name='UnauthorizedError';code='P5007';constructor(r,t=yo){super(t,R(r,!1));}};x(Nt,'UnauthorizedError');let bo='Usage exceeded, retry again later',Lt=class extends ${name='UsageExceededError';code='P5008';constructor(r,t=bo){super(t,R(r,!0));}};x(Lt,'UsageExceededError');async function uf(e){let r;try{r=await e.text();}catch{return{type:'EmptyError'};}try{const t=JSON.parse(r);if(typeof t=='string')switch(t){case'InternalDataProxyError':return{type:'DataProxyError',body:t};default:return{type:'UnknownTextError',body:t};}if(typeof t=='object'&&t!==null){if('is_panic'in t&&'message'in t&&'error_code'in t)return{type:'QueryEngineError',body:t};if('EngineNotStarted'in t||'InteractiveTransactionMisrouted'in t||'InvalidRequestError'in t){const n=Object.values(t)[0].reason;return typeof n=='string'&&!['SchemaMissing','EngineVersionNotSupported'].includes(n)?{type:'UnknownJsonError',body:t}:{type:'DataProxyError',body:t};}}return{type:'UnknownJsonError',body:t};}catch{return r===''?{type:'EmptyError'}:{type:'UnknownTextError',body:r};}}async function Ft(e,r){if(e.ok)return;const t={clientVersion:r,response:e},n=await uf(e);if(n.type==='QueryEngineError')throw new z(n.body.message,{code:n.body.error_code,clientVersion:r});if(n.type==='DataProxyError'){if(n.body==='InternalDataProxyError')throw new Ur(t,'Internal Data Proxy error');if('EngineNotStarted'in n.body){if(n.body.EngineNotStarted.reason==='SchemaMissing')return new pr(t);if(n.body.EngineNotStarted.reason==='EngineVersionNotSupported')throw new It(t);if('EngineStartupError'in n.body.EngineNotStarted.reason){const{msg:i,logs:o}=n.body.EngineNotStarted.reason.EngineStartupError;throw new Ct(t,i,o);}if('KnownEngineStartupError'in n.body.EngineNotStarted.reason){const{msg:i,error_code:o}=n.body.EngineNotStarted.reason.KnownEngineStartupError;throw new P(i,r,o);}if('HealthcheckTimeout'in n.body.EngineNotStarted.reason){const{logs:i}=n.body.EngineNotStarted.reason.HealthcheckTimeout;throw new At(t,i);}}if('InteractiveTransactionMisrouted'in n.body){const i={IDParseError:"Could not parse interactive transaction ID",NoQueryEngineFoundError:"Could not find Query Engine for the specified host and transaction ID",TransactionStartError:"Could not start interactive transaction"};throw new Ot(t,i[n.body.InteractiveTransactionMisrouted.reason]);}if('InvalidRequestError'in n.body)throw new kt(t,n.body.InvalidRequestError.reason);}if(e.status===401||e.status===403)throw new Nt(t,Gr(yo,n));if(e.status===404)return new _t(t,Gr(go,n));if(e.status===429)throw new Lt(t,Gr(bo,n));if(e.status===504)throw new Dt(t,Gr(fo,n));if(e.status>=500)throw new Ur(t,Gr(ho,n));if(e.status>=400)throw new Rt(t,Gr(mo,n));}function Gr(e,r){return r.type==='EmptyError'?e:`${e}: ${JSON.stringify(r)}`;}function Tl(e){const r=Math.pow(2,e)*50,t=Math.ceil(Math.random()*r)-Math.ceil(r/2),n=r+t;return new Promise(i => setTimeout(() => i(n),n));}let $e='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/';function Sl(e){let r=new TextEncoder().encode(e),t='',n=r.byteLength,i=n%3,o=n-i,s,a,l,u,c;for(let p=0;p<o;p=p+3)c=r[p]<<16|r[p+1]<<8|r[p+2],s=(c&16515072)>>18,a=(c&258048)>>12,l=(c&4032)>>6,u=c&63,t+=$e[s]+$e[a]+$e[l]+$e[u];return i==1?(c=r[o],s=(c&252)>>2,a=(c&3)<<4,t+=`${$e[s]+$e[a]}==`):i==2&&(c=r[o]<<8|r[o+1],s=(c&64512)>>10,a=(c&1008)>>4,l=(c&15)<<2,t+=`${$e[s]+$e[a]+$e[l]}=`),t;}function Rl(e){if(e.generator?.previewFeatures.some(t=>t.toLowerCase().includes("metrics")))throw new P('The `metrics` preview feature is not yet available with Accelerate.\nPlease remove `metrics` from the `previewFeatures` in your schema.\n\nMore information about Accelerate: https://pris.ly/d/accelerate',e.clientVersion);}let Al={'@prisma/debug':'workspace:*','@prisma/engines-version':'6.16.1-1.bb420e667c1820a8c05a38023385f6cc7ef8e83a','@prisma/fetch-engine':'workspace:*','@prisma/get-platform':'workspace:*'};let Mt=class extends oe{name='RequestError';code='P5010';constructor(r,t){super(`Cannot fetch data from service:
${r}`,
      R(t, !0)
    );
  }
...
`);}let So=({clientMethod:e,activeProvider:r}) => t => {let n='',i;if(Vn(t))n=t.sql,i={values:Wr(t.values),__prismaRawParameters__:!0};else if(Array.isArray(t)){const[o,...s]=t;n=o,i={values:Wr(s||[]),__prismaRawParameters__:!0};}else switch(r){case'sqlite':case'mysql':{n=t.sql,i={values:Wr(t.values),__prismaRawParameters__:!0};break;}case'cockroachdb':case'postgresql':case'postgres':{n=t.text,i={values:Wr(t.values),__prismaRawParameters__:!0};break;}case'sqlserver':{n=Vl(t),i={values:Wr(t.values),__prismaRawParameters__:!0};break;}default:throw new Error(`The ${r} provider does not support ${e}`);}return i?.values?Ql(`prisma.${e}(${n}, ${i.values})`):Ql(`prisma.${e}(${n})`),{query:n,parameters:i};},Wl={requestArgsToMiddlewareArgs(e){return[e.strings,...e.values];},middlewareArgsToRequestArgs(e){const[r,...t]=e;return new ie(r,t);}},Jl={requestArgsToMiddlewareArgs(e){return[e];},middlewareArgsToRequestArgs(e){return e[0];}};function Ro(e){return function(t,n){let i,o=(s=e) => {try{return s===void 0||s?.kind==='itx'?i??=Kl(t(s)):Kl(t(s));}catch(a){return Promise.reject(a);}};return{get spec(){return n;},then(s,a){return o().then(s,a);},catch(s){return o().catch(s);},finally(s){return o().finally(s);},requestTransaction(s){const a=o(s);return a.requestTransaction?a.requestTransaction(s):a;},[Symbol.toStringTag]:'PrismaPromise'};};}function Kl(e){return typeof e.then=='function'?e:Promise.resolve(e);}let Tf=xi.split('.')[0],Sf={isEnabled(){return!1;},getTraceParent(){return'00-10-10-00'},dispatchEngineSpans(){},getActiveContext(){},runInChildSpan(e,r){return r();}},Ao=class{isEnabled(){return this.getGlobalTracingHelper().isEnabled();}getTraceParent(r){return this.getGlobalTracingHelper().getTraceParent(r);}dispatchEngineSpans(r){return this.getGlobalTracingHelper().dispatchEngineSpans(r);}getActiveContext(){return this.getGlobalTracingHelper().getActiveContext();}runInChildSpan(r,t){return this.getGlobalTracingHelper().runInChildSpan(r,t);}getGlobalTracingHelper(){const r=globalThis[`V${Tf}_PRISMA_INSTRUMENTATION`],t=globalThis.PRISMA_INSTRUMENTATION;return r?.helper??t?.helper??Sf;}};function Hl(){return new Ao;}function Yl(e,r=() => {}){let t,n=new Promise(i => t=i);return{then(i){return--e===0&&t(r()),i?.(n);}};}function zl(e){return typeof e=='string'?e:e.reduce((r,t) => {const n=typeof t=="string"?t:t.level;return n==='query'?r:r&&(t==='info'||r==='info')?'info':n;},void 0);}function zn(e){return typeof e.batchRequestIdx=='number'}function Zl(e){if(e.action!=='findUnique'&&e.action!=='findUniqueOrThrow')return;const r=[];return e.modelName&&r.push(e.modelName),e.query.arguments&&r.push(Co(e.query.arguments)),r.push(Co(e.query.selection)),r.join('');}function Co(e){return`(${Object.keys(e).sort().map(t => {const n=e[t];return typeof n=='object'&&n!==null?`(${t} ${Co(n)})`:t;}).join(' ')})`;}let Rf={aggregate:!1,aggregateRaw:!1,createMany:!0,createManyAndReturn:!0,createOne:!0,deleteMany:!0,deleteOne:!0,executeRaw:!0,findFirst:!1,findFirstOrThrow:!1,findMany:!1,findRaw:!1,findUnique:!1,findUniqueOrThrow:!1,groupBy:!1,queryRaw:!1,runCommandRaw:!0,updateMany:!0,updateManyAndReturn:!0,updateOne:!0,upsertOne:!0};function Io(e){return Rf[e];}let Zn=class{constructor(r){this.options=r;this.batches={};}batches;tickActive=!1;request(r){const t=this.options.batchBy(r);return t?(this.batches[t]||(this.batches[t]=[],this.tickActive||(this.tickActive=!0,process.nextTick(() => {this.dispatchBatches(),this.tickActive=!1;}))),new Promise((n,i) => {this.batches[t].push({request:r,resolve:n,reject:i});})):this.options.singleLoader(r);}dispatchBatches(){for(const r in this.batches){const t=this.batches[r];delete this.batches[r],t.length===1?this.options.singleLoader(t[0].request).then(n => {n instanceof Error?t[0].reject(n):t[0].resolve(n);}).catch(n => {t[0].reject(n);}):(t.sort((n,i) => this.options.batchOrder(n.request,i.request)),this.options.batchLoader(t.map(n => n.request)).then(n => {if(n instanceof Error)for(let i=0;i<t.length;i++)t[i].reject(n);else for(let i=0;i<t.length;i++){const o=n[i];o instanceof Error?t[i].reject(o):t[i].resolve(o);}}).catch(n => {for(let i=0;i<t.length;i++)t[i].reject(n);}));}}get[Symbol.toStringTag](){return'DataLoader'}};function mr(e,r){if(r===null)return r;switch(e){case'bigint':return BigInt(r);case'bytes':{const{buffer:t,byteOffset:n,byteLength:i}=Buffer.from(r,"base64");return new Uint8Array(t,n,i);}case'decimal':return new Fe(r);case'datetime':case'date':return new Date(r);case'time':return new Date(`1970-01-01T${r}Z`);case'bigint-array':return r.map(t => mr('bigint',t));case'bytes-array':return r.map(t => mr('bytes',t));case'decimal-array':return r.map(t => mr('decimal',t));case'datetime-array':return r.map(t => mr('datetime',t));case'date-array':return r.map(t => mr('date',t));case'time-array':return r.map(t => mr('time',t));default:return r;}}function Xn(e){const r=[],t=Af(e);for(let n=0;n<e.rows.length;n++){const i=e.rows[n],o={...t};for(let s=0;s<i.length;s++)o[e.columns[s]]=mr(e.types[s],i[s]);r.push(o);}return r;}function Af(e){const r={};for(let t=0;t<e.columns.length;t++)r[e.columns[t]]=null;return r;}let Cf=N('prisma:client:request_handler'),ei=class{client;dataloader;logEmitter;constructor(r,t){this.logEmitter=t,this.client=r,this.dataloader=new Zn({batchLoader:rl(async({requests:n,customDataProxyFetch:i}) => {const{transaction:o,otelParentCtx:s}=n[0],a=n.map(p=>p.protocolQuery),l=this.client._tracingHelper.getTraceParent(s),u=n.some(p=>Io(p.protocolQuery.action));return(await this.client._engine.requestBatch(a,{traceparent:l,transaction:If(o),containsWrite:u,customDataProxyFetch:i})).map((p,d) => {if(p instanceof Error)return p;try{return this.mapQueryEngineResult(n[d],p);}catch(f){return f;}});}),singleLoader:async n => {const i=n.transaction?.kind==="itx"?Xl(n.transaction):void 0,o=await this.client._engine.request(n.protocolQuery,{traceparent:this.client._tracingHelper.getTraceParent(),interactiveTransaction:i,isWrite:Io(n.protocolQuery.action),customDataProxyFetch:n.customDataProxyFetch});return this.mapQueryEngineResult(n,o);},batchBy:n => n.transaction?.id?`transaction-${n.transaction.id}`:Zl(n.protocolQuery),batchOrder(n,i){return n.transaction?.kind==='batch'&&i.transaction?.kind==='batch'?n.transaction.index-i.transaction.index:0;}});}async request(r){try{return await this.dataloader.request(r);}catch(t){const{clientMethod:n,callsite:i,transaction:o,args:s,modelName:a}=r;this.handleAndLogRequestError({error:t,clientMethod:n,callsite:i,transaction:o,args:s,modelName:a,globalOmit:r.globalOmit});}}mapQueryEngineResult({dataPath:r,unpacker:t},n){const i=n?.data,o=this.unpack(i,r,t);return process.env.PRISMA_CLIENT_GET_TIME?{data:o}:o;}handleAndLogRequestError(r){try{this.handleRequestError(r);}catch(t){throw this.logEmitter&&this.logEmitter.emit('error',{message:t.message,target:r.clientMethod,timestamp:new Date}),t;}}handleRequestError({error:r,clientMethod:t,callsite:n,transaction:i,args:o,modelName:s,globalOmit:a}){if(Cf(r),Df(r,i))throw r;if(r instanceof z&&Of(r)){const u=eu(r.meta);Nn({args:o,errors:[u],callsite:n,errorFormat:this.client._errorFormat,originalMethod:t,clientVersion:this.client._clientVersion,globalOmit:a});}let l=r.message;if(n&&(l=Tn({callsite:n,originalMethod:t,isPanic:r.isPanic,showColors:this.client._errorFormat==='pretty',message:l})),l=this.sanitizeMessage(l),r.code){const u=s?{modelName:s,...r.meta}:r.meta;throw new z(l,{code:r.code,clientVersion:this.client._clientVersion,meta:u,batchRequestIdx:r.batchRequestIdx});}else{if(r.isPanic)throw new ae(l,this.client._clientVersion);if(r instanceof V)throw new V(l,{clientVersion:this.client._clientVersion,batchRequestIdx:r.batchRequestIdx});if(r instanceof P)throw new P(l,this.client._clientVersion);if(r instanceof ae)throw new ae(l,this.client._clientVersion);}throw r.clientVersion=this.client._clientVersion,r;}sanitizeMessage(r){return this.client._errorFormat&&this.client._errorFormat!=='pretty'?wr(r):r;}unpack(r,t,n){if(!r||(r.data&&(r=r.data),!r))return r;const i=Object.keys(r)[0],o=Object.values(r)[0],s=t.filter(u=>u!=="select"&&u!=="include"),a=ao(o,s),l=i==="queryRaw"?Xn(a):Vr(a);return n?n(l):l;}get[Symbol.toStringTag](){return'RequestHandler'}};function If(e){if(e){if(e.kind==='batch')return{kind:'batch',options:{isolationLevel:e.isolationLevel}};if(e.kind==='itx')return{kind:'itx',options:Xl(e)};ar(e,'Unknown transaction kind');}}function Xl(e){return{id:e.id,payload:e.payload};}function Df(e,r){return zn(e)&&r?.kind==='batch'&&e.batchRequestIdx!==r.index;}function Of(e){return e.code==='P2009'||e.code==='P2012'}function eu(e){if(e.kind==='Union')return{kind:'Union',errors:e.errors.map(eu)};if(Array.isArray(e.selectionPath)){const[,...r]=e.selectionPath;return{...e,selectionPath:r};}return e;}let ru=xl;let su=O(Ki());let _=class extends Error{constructor(r){super(`${r}
Read more at https://pris.ly/d/client-constructor`),this.name='PrismaClientConstructorValidationError'}get[Symbol.toStringTag](){return'PrismaClientConstructorValidationError'}};x(_,'PrismaClientConstructorValidationError');let tu=['datasources','datasourceUrl','errorFormat','adapter','log','transactionOptions','omit','__internal'],nu=['pretty','colorless','minimal'],iu=['info','query','warn','error'],kf={datasources:(e,{datasourceNames:r}) => {if(e){if(typeof e!='object'||Array.isArray(e))throw new _(`Invalid value ${JSON.stringify(e)} for "datasources" provided to PrismaClient constructor`);for(const[t,n]of Object.entries(e)){if(!r.includes(t)){const i=Jr(t,r)||` Available datasources: ${r.join(", ")}`;throw new _(`Unknown datasource ${t} provided to PrismaClient constructor.${i}`);}if(typeof n!='object'||Array.isArray(n))throw new _(`Invalid value ${JSON.stringify(e)} for datasource "${t}" provided to PrismaClient constructor.
