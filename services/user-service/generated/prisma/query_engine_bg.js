...
const B = (e, t) => {
    for (const n in t) S(e, n, { get: t[n], enumerable: !0 });
  },
  U = (e, t, n, o) => {
...
const L = e => U(S({}, '__esModule', { value: !0 }), e);
const Et = {};
B(Et, {
  QueryEngine: () => Q,
...
function W(e) {
  const t = l(e) ? 0 : f(e, r.__wbindgen_malloc, r.__wbindgen_realloc),
    n = s;
...
class Q {
  ...
  query(t, n, o, _) {
    const i = f(t, r.__wbindgen_malloc, r.__wbindgen_realloc),
      ...
      a = s;
    const d = l(o) ? 0 : f(o, r.__wbindgen_malloc, r.__wbindgen_realloc),
      x = s;
...
function St(e, t) {
  ...
  const _ = l(o) ? 0 : f(o, r.__wbindgen_malloc, r.__wbindgen_realloc),
    i = s;
